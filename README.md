...
WaifuX Linux 是一个 Qt 6 / QML 桌面应用，使用 C++/Qt 提供壁纸搜索、动态壁纸、动漫资料、本地资源库和 Linux 桌面设置能力。不再使用 Electron、Node 前端运行时、HTML、CSS 或 WebView。
...
- Linux 静态壁纸设置。
- Linux 动态壁纸依赖检查，并可生成本机安装辅助脚本。

## 环境要求

- CMake
- g++
- Qt 6 base/declarative 开发包：
  - `qt6-base-dev`
  - `qt6-declarative-dev`
  - `qml6-module-qtquick`
